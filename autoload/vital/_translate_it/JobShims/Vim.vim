...
execute join(['function! vital#_translate_it#JobShims#Vim#import() abort', printf("return map({'job_stop': '', 'job_status': '', 'job_start': '', 'job_setoptions': '', 'ch_sendraw': ''}, \"vital#_translate_it#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
" ===========================
